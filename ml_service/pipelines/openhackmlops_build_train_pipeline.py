...
def main():
    ...
    run_config.environment = Environment.from_conda_specification(name="scoringenv", file_path="openhackmlops/conda_dependencies.yml")  # NOQA: E501
    ...
    if dataset_name not in aml_workspace.datasets:
        ...
        dataset = dataset.register(
            ...
            name=dataset_name,
            description="openhackmlops training data",
            tags={"format": "CSV"},
